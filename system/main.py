...
if __name__ == "__main__":
    ...
    parser.add_argument('-CUDA_VISIBLE_DEVICES', "--CUDA_VISIBLE_DEVICES", type=int, default=0, help="CUDA_VISIBLE_DEVICES")
    ...
    print("CUDA_VISIBLE_DEVICES: {}".format(args.CUDA_VISIBLE_DEVICES))
    print("=" * 50)
