...
import copy
import random
from flcore.clients.clientloradattruemoe import clientLORADATTRUEMOE
from flcore.servers.serverbase import Server
from threading import Thread
import statistics
import torch

from flcore.trainmodel.clip_model_moe import *


class FLoraDATTrueMoE(Server):
    def __init__(self, args, times):
        ...
        self.clip_model_object = CLIPModelWithLoRACombinedMoE(model_checkpoint=args.model_checkpoint, home_dir=args.home_dir, lora_params_global=self.lora_params, lora_params_local=self.lora_params, moe_params=self.moe_params)
        
        self.global_model = copy.deepcopy(self.clip_model_object.lora_layers_global)    # dict of params
        
        self.set_clients(clientLORADATTRUEMOE)
    ...
    def train(self):
        ...
        if self.num_new_clients > 0:
            ...
            self.set_new_clients(clientLORADATTRUEMOE)
