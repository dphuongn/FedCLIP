...
import copy
import random
from flcore.clients.clientsoradualheterothaw import clientSORADUALHETEROTHAW
...
class FSoraDualHeteroThaw(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientSORADUALHETEROTHAW)
    ...
    def train(self):
        ...
        if self.num_new_clients > 0:
            ...
            self.set_new_clients(clientSORADUALHETEROTHAW)
