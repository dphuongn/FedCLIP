...
import copy
import random
from flcore.clients.clientsoradualheterocombined import clientSORADUALHETEROCOMBINED
...
class FSoraDualHeteroCombined(Server):
    def __init__(self, args, times):
        ...
        self.clip_model_object = CLIPModelWithSoRADualHeteroCombined(model_checkpoint=args.model_checkpoint, home_dir=args.home_dir, lora_params_global=self.lora_params, lora_params_local=self.lora_params_local)
        
        self.global_model = copy.deepcopy(self.clip_model_object.lora_layers_global)    # dict of params
        
        self.set_clients(clientSORADUALHETEROCOMBINED)
    ...
    def train(self):
        ...
        if self.num_new_clients > 0:
            ...
            self.set_new_clients(clientSORADUALHETEROCOMBINED)
