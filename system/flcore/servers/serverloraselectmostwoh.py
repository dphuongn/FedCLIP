...
import copy
import random
from flcore.clients.clientloraselectmostwoh import clientLORASELECTMOSTWOH
...
class FLoraSelectMostWoH(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientLORASELECTMOSTWOH)
    ...
    def initialize_client_layers(self):
        ...
        for client in self.clients:
            ...
            client.send_most_important_layers(sorted_layers)
