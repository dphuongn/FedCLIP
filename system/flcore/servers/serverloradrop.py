...
import copy
import random
from flcore.clients.clientloradrop import clientLORADROP
...
class FLoraDrop(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientLORADROP)
    ...
    def initialize_client_layers(self):
        ...
        for client in self.clients:
            ...
            client.remove_least_important_layers(sorted_layers)
