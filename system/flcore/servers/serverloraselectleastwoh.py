...
import copy
import random
from flcore.clients.clientloraselectleastwoh import clientLORASELECTLEASTWOH
...
class FLoraSelectLeastWoH(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientLORASELECTLEASTWOH)
    ...
    def initialize_client_layers(self):
        ...
        for client in self.clients:
            ...
            client.send_least_important_layers(sorted_layers)
