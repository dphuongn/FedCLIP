...
import copy
import random
from flcore.clients.clientloraselectnonhead import clientLORASELECTNONHEAD
...
class FLoraSelectNonHead(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientLORASELECTNONHEAD)
    ...
    def initialize_client_layers(self):
        ...
        for client in self.clients:
            client.send_non_projection_lora_layers()
    ...
    def train(self):
        ...
        if self.num_new_clients > 0:
            ...
            self.set_new_clients(clientLORASELECTNONHEAD)
