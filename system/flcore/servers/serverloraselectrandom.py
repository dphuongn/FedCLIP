...
import copy
import random
from flcore.clients.clientloraselectrandom import clientLORASELECTRANDOM
...
class FLoraSelectRandom(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientLORASELECTRANDOM)
    ...
    def initialize_client_layers(self):
        ...
        for client in self.clients:
            client.send_random_k_lora_layers()
