...
import copy
import random
from flcore.clients.clientloradattruehalf import clientLORADATTRUEHALF
from flcore.servers.serverbase import Server
from threading import Thread
import statistics
import torch

from flcore.trainmodel.clip_model_dattruehalf import *


class FLoraDATTrueHalf(Server):
    def __init__(self, args, times):
        ...
        self.set_clients(clientLORADATTRUEHALF)
    ...
    def train(self):
        ...
        if self.num_new_clients > 0:
            ...
            self.set_new_clients(clientLORADATTRUE)
