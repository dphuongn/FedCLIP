...
class CLIPModelWithDualLoRA(nn.Module):
    ...
    def _apply_lora_combined(self):
        ...
        # # 1) TEXT ENCODER: **only** patch the pooled projection
        # #    (input to text_projection is [B, hidden_dim], so gating_net sees whole sentence)
        # if self.lora_params_global.get('lora_head_text'):
        #     patch(self.model_combined, 'text_projection', 'text_projection')
    ...
    def print_trainable_params(self):
        ...
        print(f"[DualLoRA CLIP] Total trainable parameters: {total:,}")
...
if __name__ == "__main__":
    ...
    CLIPModelWithDualLoRA_object.print_trainable_params()
