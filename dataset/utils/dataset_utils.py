...
def check(config_path, train_path, test_path, num_clients, num_classes, niid=False, 
    ...
    # Ensure the directories for train and test paths exist
...
def save_file(config_path, train_path, test_path, train_data, test_data, num_clients, num_classes,
                client_details, niid=False, balance=False, partition=None, alpha=None, few_shot=False, n_shot=None, pfl=False):
    config = {
        ...
        'partition': partition, 
        'alpha': alpha, 
        'batch_size': None,  # Specify this if you have a batch_size
        'few_shot': few_shot,
        'n_shot': n_shot,
        'pfl': pfl,
        'client_details': client_details,  # Add client details to the config
    }
