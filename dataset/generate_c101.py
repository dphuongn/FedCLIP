...
dir_path = Path("caltech101")
num_classes = 101

# Allocate data to users
def generate_caltech101(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl):
    ...
    trainset = torchvision.datasets.Caltech101(
        root=dir_path / "rawdata", download=True, transform=transform)
    ...
    dataset_image = train_images
    dataset_label = train_labels
...
if __name__ == "__main__":
    ...
    generate_caltech101(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl)