...
dir_path = Path("dtd_ref")
num_classes = 47

# Allocate data to users
def generate_dtd(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl):
...
if __name__ == "__main__":
    ...
    generate_dtd(dir_path, num_clients, num_classes, niid, balance, partition, alpha, few_shot, n_shot, pfl)