...
def plot_multiple_accuracy_curves(filenames, labels, colors):
    ...
    plt.savefig(f'{dataset}_{partition}_{alg}_{r}_{rl}_{a}_{sl}_{gl}_gg_sd_all_pfl.pdf', format='pdf', bbox_inches='tight')

    plt.close()


# lrs = ['1e-5']                      # fsoradualheterov dir 
lrs = ['5e-5']                      # fsoradualheterot dir 

# lrs = ['1e-5']                      # fsoradualheterov dir001
# lrs = ['5e-5']                      # fsoradualheterot dir001


# gammas_local = ['0.01']             # fsoradualheterov dir, dir001
# gammas_local = ['0.1']              # fsoradualheterov 
gammas_local = ['1']                # fsoradualheterot dir 
# gammas_local = ['10']               # fsoradualheterot dir001

# gammas_global = ['0.01', '0.1', '10', '100']             # fsoradualheterov dir
gammas_global = ['0.01', '0.1', '10', '100']             # fsoradualheterot dir
                    ...
                    for wd in wds:
                        for r in ranks:
                            for rl in ranks_local:
                                for a in alphas:
                                    filenames.append(f'../../logs/{dataset}/{dataset}_{partition}_{alg}_lr{lr}_wd{wd}_r{r}_rl{rl}_a{a}_sl{sl}_gl{gl}_gg{gg}_sd{sd}_all_pfl.out')
                                    labels.append(f'lr={lr}, wd={wd}, r={r}, rl={rl}, a={a}, sl={sl}, gl={gl}, gg={gg}, sd={sd}')
