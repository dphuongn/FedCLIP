...
# lrs = ['1e-5', '5e-6']                        # dir florav    
lrs = ['1e-6', '5e-7']                        # dir florat

# lrs = ['1e-5', '5e-6', '1e-6']                # dir10 florav    
# lrs = ['1e-5', '5e-6', '1e-6']                # dir10 florat

# lrs = ['1e-5', '5e-6', '1e-6']                # dir001 florav    
# lrs = ['1e-6']                                # dir001 florat
...
for te in tes:
    for lr in lrs:
        for wd in wds:
            for r in ranks:
                for a in alphas:
                    filenames.append(f'../../logs/{dataset}/{dataset}_{partition}_{alg}_lr{lr}_wd{wd}_r{r}_a{a}_te{te}_all_pfl.out')
                    labels.append(f'lr={lr}, wd={wd}, r={r}, a={a}, te={te}')
