...
alg = 'floradattruehalfv'
# alg = 'floradattruehalft'
# alg = 'floradattruehalf2'
...
def plot_multiple_accuracy_curves(filenames, labels, colors):
    ...
    plt.savefig(f'{dataset}_{partition}_{alg}_{r}_{a}_all_pfl.pdf', format='pdf', bbox_inches='tight')

    plt.close()

lrs = ['5e-5', '1e-5', '5e-6', '1e-6']

# lrs = ['1e-5', '5e-6', '1e-6']                    # dir floradattruehalfv
# lrs = ['5e-5', '1e-5', '5e-6', '1e-6']            # dir floradattruehalft

# lrs = ['1e-5', '5e-6', '1e-6']                    # dir10 floradattruehalfv
# lrs = ['1e-5', '5e-6', '1e-6']                    # dir10 floradattruehalft

# lrs = ['1e-5', '5e-6']                            # dir001 floradattruehalfv
# lrs = ['5e-5', '1e-5', '5e-6', '1e-6']            # dir001 floradattruehalft
...
for lr in lrs:
    for wd in wds:
        for r in ranks:
            for a in alphas:
                filenames.append(f'../../logs/{dataset}/{dataset}_{partition}_{alg}_lr{lr}_wd{wd}_r{r}_a{a}_all_pfl.out')
                labels.append(f'lr={lr}, wd={wd}, r={r}, a={a}')
